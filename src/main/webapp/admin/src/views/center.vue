  ...
  <div :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='yonghu'"  label="学历" prop="xueli">
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='qiye'" label="企业logo" prop="qiyelogo">
          <file-upload
          tip="点击上传企业logo"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='qiye'"  label="企业性质" prop="qiyexingzhi">
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='qiye'" label="营业执照" prop="yingyezhizhao">
          <file-upload
          tip="点击上传营业执照"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='qiye'"  label="公司电话" prop="gongsidianhua">
          <el-input v-model="ruleForm.gongsidianhua"               placeholder="公司电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='qiye'"  label="人事姓名" prop="renshixingming">
          <el-input v-model="ruleForm.renshixingming"               placeholder="人事姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='qiye'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='qiye'"  label="企业邮箱" prop="qiyeyouxiang">
		...
		<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='qiye'" label="企业介绍" prop="qiyejieshao">
		  <editor
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.qiyemingcheng)&& 'qiye'==this.flag){
        ...
        if(this.ruleForm.qiyemingcheng && ((this.ruleForm.qiyemingcheng).toString().length<3) && `qiye` == this.flag){
      ...
      if((!this.ruleForm.mima)&& 'qiye'==this.flag){
        ...
        if(this.ruleForm.mima && ((this.ruleForm.mima).toString().length<3) && `qiye` == this.flag){
            this.$message.error(`密码长度不能小于3`);
            return
        }

      if((!this.ruleForm.qiyelogo)&& 'qiye'==this.flag){
      ...
      if( 'qiye' ==this.flag && this.ruleForm.status&&(!isIntNumer(this.ruleForm.status))){
       this.$message.error(`状态应输入整数`);
        return
      }


      if( 'qiye' ==this.flag && this.ruleForm.passwordwrongnum&&(!isIntNumer(this.ruleForm.passwordwrongnum))){
       this.$message.error(`密码错误次数应输入整数`);
        return
      }
