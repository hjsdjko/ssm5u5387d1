<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="通知标题" prop="tongzhibiaoti">
					<el-input v-model="ruleForm.tongzhibiaoti" placeholder="通知标题" clearable  :readonly="ro.tongzhibiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="通知标题" prop="tongzhibiaoti">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="date" v-if="type!='info'" label="面试时间" prop="mianshishijian">
					<el-date-picker
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.mianshishijian" label="面试时间" prop="mianshishijian">
					<el-input v-model="ruleForm.mianshishijian" placeholder="面试时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="面试地点" prop="mianshididian">
					<el-input v-model="ruleForm.mianshididian" placeholder="面试地点" clearable  :readonly="ro.mianshididian"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="面试地点" prop="mianshididian">
