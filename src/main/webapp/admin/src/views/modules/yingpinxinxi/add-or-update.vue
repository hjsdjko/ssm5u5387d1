	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="岗位分类" prop="gangweifenlei">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info'&& !ro.gerenjianli" label="个人简历" prop="gerenjianli">
					<file-upload
						tip="点击上传个人简历"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="申请原因" prop="shenqingyuanyin">
					<el-input v-model="ruleForm.shenqingyuanyin" placeholder="申请原因" clearable  :readonly="ro.shenqingyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="申请原因" prop="shenqingyuanyin">
