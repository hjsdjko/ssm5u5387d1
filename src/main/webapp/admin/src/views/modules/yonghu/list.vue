<template>
	<div class="main-content" :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 0px","fontSize":"inherit","flexWrap":"wrap","display":"flex"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"flexWrap":"wrap","margin":"0 0 10px","display":"flex"}'>
					...
					<el-button class="btn18" v-if="isAuth('yonghu','学历统计')" type="success" @click="chartDialog1()">
		...
		<el-dialog
		  ...
		  width="800">
			<div id="xueliChart1" style="width:100%;height:600px;"></div>
...
//统计接口
    chartDialog1() {
      ...
      this.$nextTick(()=>{
        var xueliChart1 = echarts.init(document.getElementById("xueliChart1"),'dark');
        this.$http({
    ...
    init () {
          ...
          this.xueliOptions = "硕士,本科,专科".split(',')
    },
    search() {
      this.pageIndex = 1;
      this.getDataList();
