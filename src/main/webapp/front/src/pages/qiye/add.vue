...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="企业logo" v-if="type!='cross' || (type=='cross' && !ro.qiyelogo)" prop="qiyelogo">
            <file-upload
            tip="点击上传企业logo"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' class="upload" v-else label="企业logo" prop="qiyelogo">
                ...
                <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.qiyelogo.split(',')" :src="baseUrl+item" width="100" height="100">
            </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="企业性质" prop="qiyexingzhi">
            <el-select v-model="ruleForm.qiyexingzhi" placeholder="请选择企业性质" :disabled=" false  ||ro.qiyexingzhi" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="企业介绍" prop="qiyejieshao">
            <editor 
  ...
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='qiyelogo'){
              this.ruleForm.qiyelogo = obj[o].split(",")[0];
    ...
    // 多级联动参数
      ...
      qiyelogoUploadChange(fileUrls) {
          this.ruleForm.qiyelogo = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
